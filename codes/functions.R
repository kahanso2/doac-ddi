...
###ICD-9
####Diagnosis codes "indicating" bleeding - Dx code required to be principal discharge diagnosis
gib_icd9_ind <- c("^5310.*", "^5312.*", "^5314.*", "^5316.*", "^5320.*", "^5322.*", "^5324.*", "^5326.*", "^5330.*", "^5332.*", "^5334.*",
                  "^5336.*", "^5340.*", "^5342.*", "^5344.*", "^5346.*", "^53501", "^53511", "^52521", "^53531", "^53541",
                  "^53551", "^53561", "^53783", "^4560", "^45620", "^5307", "^53021", "^53082", "^578", "^4552", "^4555",
                  "^4558", "^56202", "^56203", "^56212", "^56213", "^56881", "^5693", "^56985", "^5781", "^5789")
gu_icd9_ind <- c("^59381", "^8997.*", "^6238", "^6266")
...
all_icd9_bleeds_ind <- paste(all_icd9_bleeds, collapse = "|")
...
all_icd9_bleeds_possible <- paste(all_icd9_bleeds, collapse = "|")




#need to add ^ for all below
...
test_pattern2 <- paste(gib_icd10_ind, collapse = "|")
...
other_icd10_ind <- c("M2500", "M25011", "M25012", "M25019", "M25021", "M25022", "M25029", 
...
gu_icd10_possible <- c("K251", "K253", "K255", "K257", "K259","K261", "K263",
...
#Object vector
object <- c("Dabigatran", "Apixaban", "Rivaroxaban", "Edoxaban", "Betrixaban", "Warfarin")
object_test <- "Warfarin"

#Precipitant(s) vector
precipitant <- c("Ibuprofen", "Fluconazole", "Lisinopril", "Gemfibrozil", "Clarithromycin", "Levothyroxin", "Metformin")

#cont_enroll_req day requirement
cont_enroll_req <- 183

#New user requirement
new_user_req <- '2010-07-03'
